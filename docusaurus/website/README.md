...
1. If you want your page to show up in your navigation header, you will need to update `website/docusaurusConfig.js` to add to the `headerLinks` element:
